...
export default function Settings() {
  ...
  const canEditGeneralSettings = currentUser?.role === 'admin' || currentUser?.role === 'pujasera_admin';
        ...
        <Card className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="font-semibold capitalize">{currentUser?.role.replace(/_/g, ' ')}</p>
                </div>
            </div>
            <div className="flex items-center gap-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-start gap-2">
                            <Textarea 
                                ...
                                placeholder={currentUser?.role === 'pujasera_admin' ? 'Contoh: Food court dengan beragam pilihan makanan' : 'Contoh: Kafe modern dengan kopi spesialti'}
